...
<%
	...
	request.setAttribute("mobile", num);
	...
	if (num != null && !num.equals("")) {
		try {
			...
			List<Product> tempData = query.queryProduct(num);
...
<body style="background-color: #ffffff">
	...
	<table width="100%" border="0" align="center" cellpadding="0"
		cellspacing="0">
		<tr>
			<td><a href="http://c.tb.cn/c.HtCp"><img
			...
			<li>
				<div class="am-gallery-item">
					<a href="${item.url}" class=""
						onclick="addOrderRecord('${item.code}','${mobile}')" target="_blank"> <img
						src="${item.imgUrl}" alt="" />
  ...
  am-avg-md-3 am-avg-lg-3 am-gallery-default"
		...
		<li>
			<div class="am-gallery-item">
				<a href="http://www.10010.com/02M7e" class=""> <img
					src="images/iphone6s.jpg" alt="" />
					<h3 class="am-gallery-title">iPhone 6s/6sp(64G)</h3>
				</a>
			</div>
		</li>
		<li>
			<div class="am-gallery-item">
				<a href="http://www.10010.com/02M7f" class=""> <img
					src="images/iphone6.jpg" />
					<h3 class="am-gallery-title">iPhone 6/6 Plus</h3>
				</a>
			</div>
		</li>
		<li>
			<div class="am-gallery-item">
				<a href="http://www.10010.com/02M7b" class=""> <img
					src="images/4gpackage.jpg" />
	...
	<div data-am-widget="navbar" class="am-navbar am-cf am-navbar-default"
		...
		<ul class="am-navbar-nav am-cf am-avg-sm-4">
			<li><a
				href="http://wap.10010hb.net/hbwebvas/wap/accountBalance.jsp?usernumber=<%=encryptMobile%>"
				class=""> <span class="am-icon-tty"></span> <span
					class="am-navbar-label">实时话费</span>
			</a></li>
			<li><a
				href="http://wap.10010hb.net/hbwebvas/wap/packageUsage.jsp?usernumber=<%=encryptMobile%>"
				class=""> <span class="am-icon-hourglass-o"></span> <span
					class="am-navbar-label">套餐详细</span>
			</a></li>
			<li><a
				href="http://wap.10010hb.net/hbwebvas/wap/flowBalance.jsp?usernumber=<%=encryptMobile%>"
				class=""> <span class="am-icon-rocket"></span> <span
					class="am-navbar-label">流量详细</span>
			</a></li>
			<!-- 
			<li><a href="http://wap.10010.com/t/siteMap.htm?menuId=query"
				class=""> <span class="am-icon-plus-circle"></span> <span
					class="am-navbar-label">更多</span>
			</a></li>
	...
	<script type="text/javascript">
		function addOrderRecord(code, mobile) {
			$.get("http://113.57.230.176:8888/404/admin/productAction?reqType=4&code="+code+"&mobile="+mobile);
		}
	</script>
</body>
</html>
